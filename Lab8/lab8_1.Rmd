...
This data would probably be easier to read is we made a vector that matched up our accession numbers with our species. Let's do that! We'll add the name of the gene we're looking at for good measure. This is good practice, especially if you might want to add other sequences later.
```{r}
