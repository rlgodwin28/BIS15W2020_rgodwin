...
Let's look for our lizard sequences for the species Basiliscus basiliscus using entrez_search(). We can tell entrez we want to search the nucleotide database (nuccore) for Basiliscus basiliscus which is an [Organism]. We'll also set the maximum returned hits to 40 (retmax=40).
```{r}
